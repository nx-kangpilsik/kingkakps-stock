...
namespace kingkakps.Progress
{
    public static class ProgressUtil
    {
        public static void ResetAll(bool isRealServer)
        {
            ...
            ResetAllRedisKey(Form1.LongTermBuySetKey, isRealServer);

            ResetAllRedisKey(Form1.UnderProfitBuyListKey, isRealServer);
            ResetAllRedisKey(Form1.UnderProfitBuySetKey, isRealServer);
        ...
        public static void ResetLongTermBuyList(string key, bool isRealServer)
        {
